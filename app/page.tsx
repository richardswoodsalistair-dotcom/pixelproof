...
function ProductMockup() {
  ...
  return <div className="product-window" id="product" aria-label="Design to QA analysis workspace preview">
    <div className="window-topbar"><div className="mini-brand"><Logo compact/><span>Design to QA</span></div><div className="scan-status"><span className="status-dot"/> Scan complete</div><div className="scan-summary"><strong>101</strong> issues <span>•</span> <b>71%</b> match</div></div>
...
const faqs = [
  ["What does Design to QA compare?", "Design to QA compares a Figma design with a live production or staging page, then surfaces differences in layout, spacing, typography, and missing visual elements."],
...
export default function Home() {
  ...
  return <>
    {showLoader && <div className="site-loader" role="status" aria-live="polite" aria-label="Loading Design to QA" onAnimationEnd={event => {
    ...
    <section className="final-cta section-shell"><div className="cta-glow"/><Logo compact/><span className="section-label">The final pixel deserves a final check</span><h2>Stop finding design problems<br/>during client review.</h2><p>Give design, development, and QA one measurable view of implementation quality.</p><a className="button primary" href="https://design-qa-ai.developmentpreviews.com/">See Design to QA in action <Icon name="arrow"/></a></section>
    <footer className="site-footer section-shell"><div><a className="footer-brand-link" href="https://design-qa-ai.developmentpreviews.com/" aria-label="Open Design to QA"><Logo/></a><p>Design QA, without guesswork.</p></div><div className="footer-links"><a href="#outcomes">Benefits</a><a href="#workflow">How it works</a><a href="#features">Features</a><a href="#faq">FAQs</a></div><p className="copyright">© 2026 Design to QA by Computan</p></footer>
  </main>
  </>;
}
